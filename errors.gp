// Package lo — Must/Try panic-and-recover helpers and Validate.
//
// Adapted from samber/lo v1.53.0 errors.go (MIT). Pure; panic/recover control
// flow only. Differentially tested against pinned upstream.
