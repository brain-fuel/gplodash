// Package lo — tuple constructors, zips, unzips, and cross joins.
//
// Adapted from samber/lo v1.53.0 tuples.go (MIT). Pure, deterministic,
// self-contained generics (T2..T9, Zip/ZipBy/ZipByErr, Unzip/UnzipBy/UnzipByErr,
// Unpack, CrossJoin/CrossJoinBy/CrossJoinByErr, 2..9-arity). Differentially and
// property tested against pinned upstream in tuples_test.go.
