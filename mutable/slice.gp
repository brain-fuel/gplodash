// Package mutable provides in-place slice operations.
//
// Adapted from samber/lo v1.53.0 mutable/slice.go (MIT), authored in Go+.
package mutable

import "goforge.dev/gplodash/internal/xrand"
