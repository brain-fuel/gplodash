// Package lo — Ternary, If/ElseIf/Else, and Switch/Case builders
//
// Adapted from samber/lo v1.53.0 condition.go (MIT). Pure, self-contained;
// differentially and property tested against pinned upstream.
