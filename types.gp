// Package lo — tuple value types (Tuple2..Tuple9 and their Unpack methods).
//
// Adapted from samber/lo v1.53.0 types.go (MIT). Pure mechanical generic
// product types; behavior is proven identical to upstream by tuples_test.go.

package lo

// Entry defines a key/value pairs.
// Entry[K,V] is defined in lo.gp (the map key/value pair) and intentionally
// not redeclared here.
